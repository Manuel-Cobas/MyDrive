...
const filesTableColumns = "file_id INT NOT NULL AUTO_INCREMENT, user_id INT NOT NULL, file_name VARCHAR(25), path VARCHAR(150), PRIMARY KEY (file_id), FOREIGN KEY (user_id) REFERENCES USERS(user_id)"
