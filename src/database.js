...
const filesTableColumns = "file_id INT NOT NULL AUTO_INCREMENT, user_id INT NOT NULL, file_name VARCHAR(100), path VARCHAR(150), parent_directory VARCHAR(20), PRIMARY KEY (file_id), FOREIGN KEY (user_id) REFERENCES USERS(user_id)"
